...
public class PhormerSeleniumTestCase1 {
...
//			 File file = new File("/Users/.../Library/Application Support/Firefox/Profiles/zga73n4v.default/extensions/firebug@software.joehewitt.com.xpi");
			...
			//WebElement recordButton = driver.findElement(By.id("recordButton"));
			//recordButton.click();
	        ...
	        System.out.println("anchor size: " + element.size());
	        for (int i = 0; i < element.size(); i++) {
	        	if (element.get(i).getText().contains("SlideShow")) {
	        		element.get(i).click();
	        		break;
	        	}
	        }
			...
			//recordButton = driver.findElement(By.id("recordButton"));
			//recordButton.click();
	        ...
	        System.out.println("anchor size: " + element.size());
	        for (int i = 0; i < element.size(); i++) {
	        	if (element.get(i).getText().contains("Next")) {
	        		element.get(i).click();
	        		break;
	        	}
	        }
	        
	        // Wait for some setTimeouts to expire
			Thread.sleep(18000);
