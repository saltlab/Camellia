...
public class EqualityParser {
	...
	public static ArrayList<AstNode> /* ArrayList<AstNode> */ getComparisonDependencies(InfixExpression node, boolean addLeft) {
		...
		while (it.hasNext()) {
			...
			case org.mozilla.javascript.Token.ADD:  
				...
				d.addAll(InfixExpressionParser.getOperandDependencies((InfixExpression) operand, true));
				break;
